...
public class FemaleHabitsDto
{
    ...
    public FemaleHabitsDto(FemaleHabits habitos)
    {
        Id = habitos.Id;
        ...
        RegularMenstrualCycle = habitos.RegularMenstrualCycle;
        RegularContraceptiveUse = habitos.RegularContraceptiveUse;
        Pregnant = habitos.Pregnant;
        Breastfeeding = habitos.Breastfeeding;
        HasChildren = habitos.HasChildren;
        NumberOfChildren = habitos.NumberOfChildren;
        ClientId = habitos.ClientId;
        UserId = habitos.UserId;
    }

    [JsonConstructor]
    public FemaleHabitsDto()
    {
