...
{
    Task<FacialAnamnesisDto> InsertAsync(FacialAnamnesisDto dto, string username);
    ...
    Task<FacialAnamnesisDto> UpdateAsync(long id, FacialAnamnesisDto dto, string username);
}
